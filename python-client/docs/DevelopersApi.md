...
[**parse_langingpage**](DevelopersApi.md#parse_langingpage) | **GET** /so | Extract schema.org metadata
[**parse_robots**](DevelopersApi.md#parse_robots) | **GET** /robots | Parses robots.txt to find sitemap(s)
[**parse_sitemap**](DevelopersApi.md#parse_sitemap) | **GET** /sitemap | Parses sitemap.xml
[**validate_metadata**](DevelopersApi.md#validate_metadata) | **POST** /scivalid | Validate provided schema.org JSON-LD document
...
try:
    ...
    print("Exception when calling DevelopersApi->parse_langingpage: %s\n" % e)
```
